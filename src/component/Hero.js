...
const ShoeCompanyHero = () => {
  ...
  return (
    <div style={heroSectionStyle}>
      ...
      {/* Hero Content */}
      <div style={heroSectionStyle}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '20px' }}>Discover Our Latest Shoe Collection</h1>
        <p style={{ fontSize: '1.25rem', marginBottom: '40px' }}>Step into style and comfort with our premium footwear.</p>
